      ...
      {devices.map((device, index) => {
        ...
        return (
          <tr key={device.id}>
            ...
            <td>{device.dynamicParams.minAvailableMemory.toString()}</td>{" "}
            {/* Convert BigNumber to string */}
            <td>{device.dynamicParams.maxAvailableMemory.toString()}</td>{" "}
            {/* Convert BigNumber to string */}
            {/* <td>{device.dynamicParams.cpuUsage.toString()}</td> Convert BigNumber to string */}
            <td>{device.dynamicParams.minCpuUsage.toString()}</td>{" "}
            {/* Convert BigNumber to string */}
            <td>{device.dynamicParams.maxCpuUsage.toString()}</td>{" "}
            {/* Convert BigNumber to string */}
            <td>{device.dynamicParams.minCpuPercentage.toString()}</td>{" "}
            {/* Convert BigNumber to string */}
            <td>{device.dynamicParams.maxCpuPercentage.toString()}</td>{" "}
            {/* Convert BigNumber to string */}
            <td>{device.dynamicParams.minNetworkBandwidth.toString()}</td>{" "}
            {/* Convert BigNumber to string */}
            <td>{device.dynamicParams.maxNetworkBandwidth.toString()}</td>{" "}
            {/* Convert BigNumber to string */}
          </tr>
        )
      })}
