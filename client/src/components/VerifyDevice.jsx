...
//       state.contract.on("DeviceIntegrityChecked", (isIntegrityValid) => {
//         setVerificationResult(isIntegrityValid)
//         setIsLoading(false)
//       })

//       const tx = await state.contract.checkDeviceIntegrity(
...
//           Verification successful! Device is verified.
//         </Alert>
//       )
//     } else if (verificationResult === false) {
//       return (
//         <Alert variant="danger">
//           Verification failed! Device is not verified.
//         </Alert>
//       )
//     } else if (error) {
...
const VerifyDevice = ({ state }) => {
  ...
  const handleJsonUpload = (e) => {
    ...
    reader.onload = () => {
      ...
      setStaticParams(parsedData.staticParams)
      setDynamicParams(parsedData.dynamicParams)
  ...
  return (
    <div>
      {renderAlert()}
      <Row>
        <Form.Group className="mb-3" as={Col} controlId="formFile">
